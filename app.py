...
<div class="main-header">
    ...
    <p>Tác giả: Phạm Thị Hồng Nhung - Trường Tiểu học Chân Sơn - ĐT: 098 333 839</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phạm Thị Hồng Nhung - Trường Tiểu học Chân Sơn - ĐT: 098 333 839</div>", unsafe_allow_html=True)
